module fund_consts
  ...
  real(8), parameter :: R_e    = 2*6371*10e3     ! Earth radius in m
  real(8), parameter :: T_stel = 5777            ! temperature of the star (Sun)
...
module dimensions
  ...
  integer, parameter :: nGas      = 4!3           ! number of species
  ...
  character(len=200), save :: datadir="/Users/new/Desktop/THESIS/THESIS_PCM_LBL/data/"
