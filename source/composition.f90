module composition
  ...
  ! ### new ###
  ! added properties for some species
  ...
  real(8), parameter :: mu_He       = 4.0026      ! molar mass of CO2 [g/mol]
  real(8), parameter :: mu_O2       = 32.00     ! molar mass of CO2 [g/mol]
  ...
  real(8), parameter :: cp_He       = 5.1926       ! constant pressure specific heat of H2 at 300 K [kJ/kg/K]
  real(8), parameter :: cpCO2       = 0.84         ! constant pressure specific heat of H2 at 300 K [kJ/kg/K]
  real(8), parameter :: cp_O2       = 0.918         ! constant pressure specific heat of H2 at 300 K [kJ/kg/K]
  real(8), parameter :: cp_O3       = 0.425         ! constant pressure specific heat of H2 at 300 K [kJ/kg/K]
  real(8), parameter :: cp_CH4       = 2.181         ! constant pressure specific heat of H2 at 300 K [kJ/kg/K]

  real(8), parameter :: T0_H2O      = 273.16       ! triple point temperature [K]
  real(8), parameter :: T0_CO2      = 216.54       ! triple point temperature [K]
  real(8), parameter :: T0_He       = 2.1768       ! triple point temperature [K]
  real(8), parameter :: T0_N2       = 63.18        ! triple point temperature [K]
  real(8), parameter :: T0_O2       = 54.361        ! triple point temperature [K]
  real(8), parameter :: T0_CH4      = 90.69
  
  real(8), parameter :: p0_CO2      = 5.185e5      ! triple point pressure [Pa]
  real(8), parameter :: p0_H2O      = 610.78       ! triple point pressure [Pa]
  real(8), parameter :: p0_He       = 5048        ! triple point pressure [Pa]
  real(8), parameter :: p0_N2       = 0.124        ! triple point pressure [Pa]
  real(8), parameter :: p0_O2       = 0.00144       ! triple point pressure [Pa]
  real(8), parameter :: p0_CH4      = 9321.9
  ...
  real(8), parameter :: rho_He_0    = 0.166        ! Helium density [kg/m3]
  real(8), parameter :: rho_CH4     = 0.657

  real(8), parameter :: sigma_c_He = 0.4e-19     ! collision cross section He
  real(8), parameter :: sigma_c_N2 = 0.44e-19     ! collision cross section He
  
  public cp_N2, cp_H2, R_H2O, cpCO2, cp_He, cp_O2, cp_O3, cp_CH4
  public rho_H2O_ice, rho_CO2_ice, rho_dust, rho_He_0, rho_CH4
  public mu_CO2, mu_H2O, mu_N2, mu_H2, mu_SO2, mu_H2S, mu_CH4, mu_O3, mu_NH3, mu_He, mu_O2
  public sigma_c_He, sigma_c_N2
  ...
  logical :: check_He = .false.     ! ### new ### check if He is present
  ...
  public :: gas_molarconc, gas_name, check_He
  ...
  subroutine composition_init 
    ...
    do iGas=1,nGas
       ...
       elseif (gas_name(iGas)=="He_") then
          check_He = .true.        ! ### new ### set to true if He present
          iGas_He=iGas
          count=count+1
